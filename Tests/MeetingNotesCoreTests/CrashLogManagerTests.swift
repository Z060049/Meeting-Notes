...
final class CrashLogManagerTests: XCTestCase {
    func testNextLaunchCreatesIncidentForUnexpectedExit() throws {
        ...
        let logURL = root.appendingPathComponent("MeetingNotes.log")
        ...
        try "sample crash".write(
            to: systemReports.appendingPathComponent("MeetingNotes-2026-07-12.ips"),
            atomically: true,
            encoding: .utf8
        )
        ...
        XCTAssertTrue(
            FileManager.default.fileExists(
                atPath: incidentURL.appendingPathComponent("MeetingNotes-2026-07-12.ips").path
            )
        )
    }
    ...
    func testCleanShutdownDoesNotCreateIncident() {
        ...
        let manager = makeManager(
            ...
            logURL: root.appendingPathComponent("MeetingNotes.log")
        )
