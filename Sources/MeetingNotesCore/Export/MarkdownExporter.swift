...
public final class MarkdownExporter: @unchecked Sendable {
    ...
    /// Writes the unmodified transcript immediately after Whisper finishes,
    /// before de-duplication and LLM summarization. This acts as a safe fallback
    /// and preserves the source material needed to diagnose cleaning behavior.
    @discardableResult
