...
public final class PersistentDiagnosticLog: @unchecked Sendable {
    ...
    public init(
        ...
        self.logURL = directory.appendingPathComponent("MeetingNotes.log")
        self.archivedLogURL = directory.appendingPathComponent("MeetingNotes.previous.log")
    ...
    public func log(
        ...
        do {
            ...
            fputs("MeetingNotes diagnostic logging failed: \(error)\n", stderr)
        }
    }
