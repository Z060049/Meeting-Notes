...
public final class CrashLogManager: @unchecked Sendable {
    ...
    public convenience init(fileManager: FileManager = .default) {
        ...
        let stateDirectory = applicationSupport
            .appendingPathComponent("MeetingNotes/Diagnostics", isDirectory: true)
        let logDirectory = fileManager.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Logs/MeetingNotes", isDirectory: true)
        self.init(
            ...
            persistentLogURL: logDirectory.appendingPathComponent("MeetingNotes.log"),
    ...
    private func writeIncident(for marker: SessionMarker) -> URL? {
        ...
        do {
            ...
            let report = """
            MeetingNotes Unexpected Exit Report
    ...
    private func newestSystemCrashReport(since date: Date) -> URL? {
        ...
        return files
            .filter {
                $0.lastPathComponent.hasPrefix("MeetingNotes")
