...
public final class CoreAudioTapSystemAudioRecorder: SystemAudioRecording, @unchecked Sendable {
    ...
    private let ioQueue = DispatchQueue(label: "com.meetingnotes.core-audio-tap")
    ...
    private static func createAggregateDevice(tapUUID: UUID) throws -> AudioDeviceID {
        ...
        let aggregateUID = "com.meetingnotes.dev.system-audio.\(UUID().uuidString)"

        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "MeetingNotes System Audio",
